"""
Django settings for prd_test_app_2 project.
...
ROOT_URLCONF = 'prd_test_app_2.urls'
...
WSGI_APPLICATION = 'prd_test_app_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_test_app_2 API",
    "DESCRIPTION": "API documentation for prd_test_app_2 App",
    "VERSION": "v1",
}
